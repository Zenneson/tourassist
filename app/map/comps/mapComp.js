...
export default function MapComp(props) {
  ...
  const { listOpened, setListOpened, searchOpened, mapLoaded, setMapLoaded } =
    useStateContext;
  ...
  return (
    <>
      {/* <LoadingOverlay
        visible={!mapLoaded && !longitude && !latitude}
                  ...
                  <Stack p={10} gap={0} className={classes.popupFrame}>
                    ...
                    <Box className={classes.placeBlurpFrame}>
                      <Text className={classes.placeBlurp}>
                        ...
                        located just outside Washington D.C., offering a blend
                        of urban and suburban living. It's known for its lively
                        downtown area, which features a variety of shops,
                        restaurants, and entertainment options, including the
                        AFI Silver Theatre, a historic movie theater that
                        showcases independent films. The community is culturally
                        rich, hosting numerous festivals and events throughout
                        the year, such as the Silver Spring Jazz Festival.
                        Silver Spring also boasts excellent transportation
                        links, including the Metro Red Line, making it
                        convenient for commuting and exploring the wider D.C.
                        area.
                      </Text>
